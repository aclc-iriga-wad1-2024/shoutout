...
if(isset($_POST['shout-out']) && isset($_SESSION['shoutout_username']) && isset($_SESSION['shoutout_password']))
{
...
<main class="container pt-3">
    ...
    <!-- shout-out form -->
    <?php if(isset($_SESSION['shoutout_username']) && isset($_SESSION['shoutout_password'])) { ?>
        <div class="card mb-3">
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select name="user_selected" class="form-control">
                                ...
                                <?php
                                foreach ($users as $u) {
                                    if($u['username'] != $_SESSION['shoutout_username']) { // except the session owner
                                ?>
